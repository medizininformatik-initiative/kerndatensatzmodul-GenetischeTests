...
| Active as of 2026-09-07 | *Computable Name*:MII_IG_MolGen |
...
That bears on the author statement in the artifact metadata, too. Since 2027.0.0-ballot.rc2 every artifact in this module carries [CRMI](https://hl7.org/fhir/uv/crmi/) metadata including `artifact-author`. That statement refers to the **MII-specific constraint**, not to the underlying model. Clinical Genomics Reporting carries no CRMI metadata of its own; the annotation here neither replaces nor claims authorship of it.
