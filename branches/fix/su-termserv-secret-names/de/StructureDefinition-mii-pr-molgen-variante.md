# MII PR MolGen Variante - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2026.0.4

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR MolGen Variante**

## Ressourcenprofil: MII PR MolGen Variante 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/StructureDefinition/variante | *Version*:2026.0.4 |
| Active Stand: 2026-08-31 | *Maschinenlesbarer Name*:MII_PR_MolGen_Variante |
...
* Die Beschreibung komplexer Varianten, z.B. die Abbildung von 'Compound Heterozygous', erfolgt über zwei Variant Instanzen, wie [hier](http://hl7.org/fhir/uv/genomics-reporting/sequencing.html#representing-compound-heterozygotes) beschrieben
...
* [`mii-exa-molgen-variante-1`](Observation-mii-exa-molgen-variante-1.md) — Beispiel 1: Variante BRAF
* [`mii-exa-molgen-device-sequencer`](Device-mii-exa-molgen-device-sequencer.md) — Beispiel für das im vorherigen Beispiel referenzierte Device
* [`mii-exa-molgen-variante-2`](Observation-mii-exa-molgen-variante-2.md) — Beispiel 2: Variante NIPBL
* [`mii-exa-molgen-device-sequencer-2`](Device-mii-exa-molgen-device-sequencer-2.md) — Beispiel für das im vorherigen Beispiel 2 referenzierte Device
* [`mii-exa-molgen-variante-cnv-4`](Observation-mii-exa-molgen-variante-cnv-4.md) — Beispiel 3: Copy Number Variant im SMO Gen
* [`mii-exa-molgen-variante-brca1`](Observation-mii-exa-molgen-variante-brca1.md) — Beispiel 4: Variante BRCA1
...
Diese Struktur ist abgeleitet von [Variant](http://hl7.org/fhir/uv/genomics-reporting/STU3/StructureDefinition-variant.html) 
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-molgen-variante.csv), [Excel](../StructureDefinition-mii-pr-molgen-variante.xlsx), [Schematron](../StructureDefinition-mii-pr-molgen-variante.sch) 
