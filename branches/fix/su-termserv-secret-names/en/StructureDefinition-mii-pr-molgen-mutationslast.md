...
## Resource Profile: MII PR MolGen Mutationslast 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/StructureDefinition/mutationslast | *Version*:2026.0.4 |
| Active as of 2026-08-31 | *Computable Name*:MII_PR_MolGen_Mutationslast |
...
| FHIR element | Logical data set | |—|—| | Observation.valueQuantity | Ergebnisse.Mutationslast |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-molgen-mutationslast.csv), [Excel](../StructureDefinition-mii-pr-molgen-mutationslast.xlsx), [Schematron](../StructureDefinition-mii-pr-molgen-mutationslast.sch) 
