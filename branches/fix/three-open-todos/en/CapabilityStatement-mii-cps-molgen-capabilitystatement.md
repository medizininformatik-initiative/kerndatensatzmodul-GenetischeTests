...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/CapabilityStatement/metadata | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2024-11-08 | *Computable Name*:MII_CPS_MolGen_CapabilityStatement |
...
Das vorliegende CapabilityStatement beschreibt alle verpflichtenden Interaktionen die ein konformes System unterstützen muss, um das Modul MolGen der Medizininformatik-Initiative zu implementieren. 
 ...
 [Raw OpenAPI-Swagger Definition file](../mii-cps-molgen-capabilitystatement.openapi.json) | [Download](../mii-cps-molgen-capabilitystatement.openapi.json) 
