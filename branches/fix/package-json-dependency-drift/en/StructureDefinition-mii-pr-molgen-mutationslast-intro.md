...
8. The search parameter "code-value-quantity" MUST be supported:
    ...
    Usage notes: Further information on searching by "code-value-quantity" can be found in the [FHIR base specification - section "quantity"](http://hl7.org/fhir/search.html#quantity).
