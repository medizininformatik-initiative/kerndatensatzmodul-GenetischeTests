# Versioning - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2026.0.4
...
The **Molekulargenetischer Befundbericht** module follows the KDS calendar-versioning (CalVer) scheme in a SemVer-compatible numeric form:

* format **`YYYY.MINOR.PATCH[-label]`** — the current version is `2026.0.4`;
