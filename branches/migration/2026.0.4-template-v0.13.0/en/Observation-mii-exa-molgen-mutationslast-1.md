# Beispiel Mutationslast in Tumorprobe - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2026.0.4

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Beispiel Mutationslast in Tumorprobe**

## Example Observation: Beispiel Mutationslast in Tumorprobe
...
Profiles: [MII PR MolGen Mutationslast](StructureDefinition-mii-pr-molgen-mutationslast.md) version: 2026.0.4, [http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/tmb|3.0.0](https://simplifier.net/resolve?scope=de.medizininformatikinitiative.kerndatensatz.meta@2026.0.0&canonical=http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/tmb|3.0.0)
