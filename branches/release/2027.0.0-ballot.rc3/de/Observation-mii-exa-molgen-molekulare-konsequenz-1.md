# BRAF Variante Molekulare Konsequenz - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2027.0.0-ballot.rc3

* [**Inhaltsverzeichnis**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **BRAF Variante Molekulare Konsequenz**

## Beispiel Observation: BRAF Variante Molekulare Konsequenz
...
```json
{
  ...
  "meta" : {
    ...
    "https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/StructureDefinition/molekulare-konsequenz|2027.0.0-ballot.rc3",
