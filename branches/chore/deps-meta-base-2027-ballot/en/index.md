# Home - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2026.0.4
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/ImplementationGuide/mii-ig-molgen-de-v2026 | *Version*:2026.0.4 |
| Active as of 2026-01-02 | *Computable Name*:MII_IG_MolGen_DE |
...
* **[Dependencies](ImplementationGuide-mii-ig-molgen-de-v2026.md)** — the ImplementationGuide resource with the dependency table, cross-version analysis and copyright statements.
...
The content of this specification is public. Reuse and republication claims are not restricted.
