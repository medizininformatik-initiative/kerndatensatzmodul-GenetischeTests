# ValueSets - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2027.0.0-ballot.rc2
...
Diese Seite beschreibt die ValueSets des Moduls **Molekulargenetischer Befundbericht** (Namenskonvention `MII_VS_<Modul>_<Name>`). Allgemeine Hinweise zur Verwendung von Codes: siehe [FHIR Terminology](http://hl7.org/fhir/R4/terminologies.html); die zugrunde liegenden CodeSystems werden im Terminologie-Abschnitt dieser Seite beschrieben — das Modul definiert kein eigenes CodeSystem. 
...
##### Implementierungshinweise zur Terminologie
...
#### Terminologien aus Clinical Genomics

Die folgenden ValueSets und CodeSystems werden aus dem [HL7 Clinical Genomics Reporting Implementation Guide STU3](http://hl7.org/fhir/uv/genomics-reporting/STU3/) übernommen. Sie werden nicht von diesem Modul definiert.

##### CodeSystems aus Clinical Genomics
...
#### Verwendete externe Terminologien
