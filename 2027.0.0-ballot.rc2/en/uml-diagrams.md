# UML Diagrams - MII IG Kerndatensatz-Modul Molekulargenetischer Befundbericht v2027.0.0-ballot.rc2
...
![](UML_MolGenBefund2.JPG)

The module’s **domain model** — the same concepts as a class diagram, with the mapping to FHIR artefacts — is on the [Logical Models](logical-models.md) page.
