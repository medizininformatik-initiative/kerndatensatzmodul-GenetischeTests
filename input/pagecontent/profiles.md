<!-- TODO:REVIEW machine translation of input/translations/de/pagecontent/profiles.md - reviewed at Gate C -->
...
<!-- Split from the former combined profiles-and-extensions.md per the TF-KDS-agreed
     ...
     The eight migrated Simplifier index pages appear here as h3 sections; sub-headings
     that occurred more than once ("Überblick", "Kernprofile", "Verknüpfungen",
     "Wichtige Komponenten") are qualified with their profile family.
     German mirror: input/translations/de/pagecontent/profiles.md. -->
This page lists the FHIR profiles of the **Molekulargenetischer Befundbericht** module
(naming convention `MII_PR_<Module>_<Name>`, see the
[`docs/recipes/add-a-profile.md`](https://github.com/medizininformatik-initiative/kerndatensatzmodul-GenetischeTests/blob/main/docs/recipes/add-a-profile.md) in this repository, and the MII naming
...
| Profile name | Parent profile (STU3) | Description |
|--------------|----------------------|-------------|
...
| Profile name | Parent profile | Description |
|--------------|----------------|-------------|
...
2. **Sample collection**: obtaining and preparing the sample (referenced through Specimen)
3. **Performance**: genetic analysis by means of GenomicStudy
4. **Evaluation**: identification of variants and their interpretation
5. **Report creation**: consolidation of all results in the DiagnosticReport
6. **Recommendations**: derivation of therapeutic or diagnostic consequences
...
For details see [Extensions](extensions.html)
<!-- TODO:REVIEW Link target rewritten: the Simplifier source pointed at
     Extensions/Familienanamnese-Extensions.page.md; that content now lives on
     extensions.html. -->
