...
<!-- TODO:REVIEW The source page introduces this list with "the following search
     parameters are relevant for the Pathologie-Befund module" — an evident
     copy-paste error, since the page belongs to the Molekulargenetischer
     Befundbericht module and the examples use that module's resource ids. The
     sentence has been taken over unchanged. Also to be checked: the list
     describes the module's Observation search parameters as a whole and belongs
     on search-parameters.html rather than under the upstream Haplotype profile. -->

The following search parameters are relevant for the Pathologie-Befund module,
also in combination:
...
5. The search parameter "category" SHALL be supported:
...
7. The search parameter "code-value-concept" SHALL be supported:
...
8. The search parameter "code-value-quantity" SHALL be supported:
...
9. The search parameter "component-code" SHALL be supported:
...
10. The search parameter "component-code-value-concept" SHALL be supported:
...
11. The search parameter "component-code-value-quantity" SHALL be supported:
...
12. The search parameter "component-value-concept" SHALL be supported:
...
13. The search parameter "component-value-quantity" SHALL be supported:
...
14. The search parameter "date" SHALL be supported:
...
15. The search parameter "derived-from" SHALL be supported:
...
16. The search parameter "device" SHALL be supported:
...
17. The search parameter "specimen" SHALL be supported:
...
18. The search parameter "encounter" SHALL be supported:
...
19. The search parameter "method" SHALL be supported:
...
20. The search parameter "patient" SHALL be supported:
...
21. The search parameter "performer" SHALL be supported:
...
22. The search parameter "status" SHALL be supported:
