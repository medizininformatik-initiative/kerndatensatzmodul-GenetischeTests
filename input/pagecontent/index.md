...
That bears on the author statement in the artifact metadata, too. The artifacts of this
module carry [CRMI](https://hl7.org/fhir/uv/crmi/) metadata, `artifact-author` among it.
That statement refers to the **MII-specific constraint**, not to the underlying model.
Clinical Genomics Reporting carries no CRMI metadata of its own; the annotation here
neither replaces nor claims authorship of it.
