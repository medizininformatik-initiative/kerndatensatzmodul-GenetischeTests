...
* extension[relatedArtifact][=].valueRelatedArtifact.url = "https://pubmed.ncbi.nlm.nih.gov/19763162/"
* extension[relatedArtifact][+].url = "http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/CGRelatedArtifact"
* extension[relatedArtifact][=].valueRelatedArtifact.type = RelArtType#citation "Citation"
* extension[relatedArtifact][=].valueRelatedArtifact.citation = "Huisman SA, Redeker EJ, Maas SM, Mannens MM, Hennekam RC. High rate of mosaicism in individuals with Cornelia de Lange syndrome. J Med Genet. 2013 May;50(5):339-44. doi: 10.1136/jmedgenet-2012-101477. Epub 2013 Mar 15. PMID: 23505322."
* extension[relatedArtifact][=].valueRelatedArtifact.url = "https://pubmed.ncbi.nlm.nih.gov/23505322/"
* extension[relatedArtifact][+].url = "http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/CGRelatedArtifact"
* extension[relatedArtifact][=].valueRelatedArtifact.type = RelArtType#citation "Citation"
...
* extension[relatedArtifact][=].valueRelatedArtifact.url = "https://pubmed.ncbi.nlm.nih.gov/29995837/"
