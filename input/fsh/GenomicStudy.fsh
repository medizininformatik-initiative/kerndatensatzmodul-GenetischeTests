...
Description: "Genomic Study ist ein Profil, dass die Durchführung von konkreten molekulargenetischen Methoden und Assays beschreibt. Es ist vom GenomicStudyAnalysis-Profil aus dem Genomics Reporting IG abgeleitet ."
* insert Publisher
* insert PR_CS_VS_Version
* ^status = #active
