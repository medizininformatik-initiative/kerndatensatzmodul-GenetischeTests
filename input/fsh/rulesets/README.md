...
| Placeholder | Where |
|---|---|
| `2026.0.4` | `version.fsh`, `meta-profile.fsh`, `cps-rules.fsh` |
| `molgen` | `version.fsh` (package id + canonical of the package source) |
| `2026` | `version.fsh` (`resource-effectivePeriod.start`) |
| `2021` | `crmi.fsh` (`artifact-copyrightLabel`) |
| `thomas.debertshaeuser@charite.de` | `crmi.fsh` (`artifact-author`) |
| `2026-01-02` | passed in at the call site: `insert CRMIApprovalDate(2026-01-02)` |
| `C17457` | passed in at the call site: `insert CRMIArtifactTopic(…, C17457)` |
