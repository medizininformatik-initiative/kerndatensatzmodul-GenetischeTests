...
<!-- Deutsche Übersetzung von input/pagecontent/qualitaetsbericht.md
     — beide Dateien müssen dasselbe aussagen. Für diese Seite gibt es kein
     Vorlagen-Scaffold; der Seitentitel kommt aus dem Seitenset (sushi-config.yaml
     und input/includes/menu.xml) und wird hier bewusst nicht wiederholt. -->
...
<!-- TODO:REVIEW Die Zahlen im Validierungsstatus stammen aus dem Simplifier-Stand vom
     Migrationszeitpunkt (Commit 79eaf41). Nach dem ersten Lauf der Pipeline auf dem
     Modul-Template aktualisieren. -->
