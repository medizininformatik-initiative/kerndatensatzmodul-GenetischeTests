...
Dies sind Beobachtungen, die die Region oder die Regionen beschreiben, die im Rahmen dieses Befundberichts untersucht wurden.

@```
from StructureDefinition
where url='https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/StructureDefinition/untersuchte-region'
select Name: name, Canonical: url
```

---

Das Profil ist abgeleitet vom Profil [Region Studied](http://hl7.org/fhir/uv/genomics-reporting/STU3/StructureDefinition-region-studied.html) aus [HL7 Genomics Reporting Implementation Guide](http://hl7.org/fhir/uv/genomics-reporting/STU3/).

---

**Diff**

{{tree:https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/StructureDefinition/untersuchte-region, diff}}

---
**Snapshot**

{{tree:https://www.medizininformatik-initiative.de/fhir/ext/modul-molgen/StructureDefinition/untersuchte-region, snapshot}}
...
| Observation.component:region-coverage | Methoden.Read depth/Coverage |
| Observation.component:genomic-ref-seq | Methoden.Referenzsequenz |
...
{{json:example-mii-molgen-untersuchte-region-1}}  

---

Beispiel 2: NIPBL

{{json:example-mii-molgen-untersuchte-region-2-nipbl}}  

---

Beispiel 2: HDAC8

{{json:example-mii-molgen-untersuchte-region-2-hdac8}}  

---

Beispiel 2: RAD21

{{json:example-mii-molgen-untersuchte-region-2-rad21}}  

---

Beispiel 2: SMC1A

{{json:example-mii-molgen-untersuchte-region-2-smc1a}}  

---

Beispiel 2: SMC3

{{json:example-mii-molgen-untersuchte-region-2-smc3}}  

---

Beispiel 2: TP63

{{json:example-mii-molgen-untersuchte-region-2-tp63}}  

---

Beispiel 4: TP53 aus Risk-Panel Befund

{{json:mii-exa-molgen-untersuchte-region-true-risk-panel-v3-TP53}} 
